...
conda_env = "tokenhmr"
working_dir = "/home/soyongs/Codes/srcs/TokenHMR"
...
if __name__ == "__main__":
    ...
    if args.undist_img:
        ...
        suffix = "baseline"
    results_dir = os.path.join(_C.BENCHMARK_3DHP_RESULT_DIR, suffix, "tokenhmr", _C.SEQUENCE_NAME)
