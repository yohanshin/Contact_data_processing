...
conda_env = "tokenhmr"
working_dir = "/home/soyongs/Codes/srcs/GVHMR"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_gt_intrinsic", action="store_true",
        help="GT camera intrinsics after undistortion.")
    ...
    if args.use_gt_intrinsic:
        suffix = "gt_intrinsic"
    elif args.undist_img:
        suffix = "undist_img"
    else:
        suffix = "baseline"
    results_dir = os.path.join(_C.BENCHMARK_3DHP_RESULT_DIR, suffix, "gvhmr", _C.SEQUENCE_NAME)
    ...
    vitpose_base_dir = os.path.join(_C.VITPOSE_RESULTS_DIR, _C.SEQUENCE_NAME)
    ...
    for camera_idx, camera in enumerate(cameras):
        ...
        vitpose_pth = os.path.join(vitpose_base_dir, camera + ".npy")
